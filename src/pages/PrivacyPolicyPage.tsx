...
const PrivacyPolicyPage = () => {
  ...
  const sections = [
    ...
    {
      icon: <FaCreditCard size={22} color="var(--primary-orange)" />,
      ...
      content: [
        'عند طلب تمييز إعلان، نقوم بجمع:',
        {
          ...
          items: [
            ...
            'طريقة الدفع المختارة (PalPay / Jawwal Pay / BOP)',
            'المبلغ والمدة المختارة',
            'ملاحظات إضافية (اختيارية)',
          ],
        },
        'لا نحتفظ بأي بيانات بطاقات بنكية أو معلومات دفع حساسة.',
        'جميع التحويلات تتم خارج المنصة عبر التطبيقات البنكية.',
        'صور إشعارات التحويل تُستخدم فقط للتحقق من الدفع.',
        'يتم حذف صور إشعارات التحويل تلقائياً بعد 90 يوماً من الموافقة.',
        'لا نشارك صور التحويل مع أي طرف ثالث.',
      ],
    },
    {
      icon: <FaIdCard size={22} color="var(--primary-orange)" />,
      title: 'توثيق الهوية',
      subtitle: 'كيف نتعامل مع وثيقة هويتك؟',
      content: [
        'نوفر خدمة توثيق الهوية لبناء الثقة بين المستخدمين. إليك كيف نحمي بياناتك:',
        {
          type: 'list',
          items: [
            'يتم تشفير صورة وثيقة الهوية قبل حفظها',
            'يتم تخزين الوثيقة في مكان محمي وغير متاح للعامة',
            'يمكن فقط لفريق المراجعة المصرح له الوصول إليها',
            'يتم تسجيل كل عملية وصول للصورة (اسم المشرف + الوقت + السبب)',
            'يتم استخراج البيانات الأساسية فقط (الاسم، رقم الوثيقة، تاريخ الميلاد، تاريخ الانتهاء)',
            'لا نطلب أو نخزن أي بيانات إضافية غير ضرورية',
          ],
        },
    ...
    },
    {
      ...
      content: [
        'نستخدم فقط ملفات تعريف ارتباط أساسية (Essential Cookies) لتشغيل المنصة بشكل آمن:',
        {
          type: 'list',
          items: [
            'كوكيز الجلسة - للحفاظ على تسجيل دخولك',
            'كوكيز الحماية - للحماية من الهجمات الإلكترونية',
      ...
      content: [
        'نتخذ إجراءات أمنية متقدمة لحماية بياناتك:',
        {
          ...
          items: [
            ...
            'استخدام كوكيز آمنة لحماية جلستك',
            'حماية من الهجمات الإلكترونية',
            'حفظ الصور الحساسة في أماكن محمية غير متاحة للعامة',
            'تسجيل كل عملية وصول للبيانات الحساسة',
          ],
        },
          ...
          <Row className="justify-content-center">
            <Col xs={12} lg={10}>
              ...
              <div className="text-center mb-5">
                ...
                >
                  نحن في بصمة نولي خصوصيتك أهمية بالغة. نوضح في هذه السياسة
