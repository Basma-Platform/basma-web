...
import { FaEye, FaCalendarAlt, FaImage, FaHeart, FaChevronLeft, FaClipboardList } from 'react-icons/fa';
    ...
    >
      ...
      {announcements.length === 0 ? (
        <div className="text-center py-4" style={{ color: 'var(--text-muted)' }}>
          <p className="mb-2">لا توجد إعلانات حالياً</p>
          <Link
                ...
                <div className="d-flex align-items-center gap-3" style={{ minWidth: 0, flex: 1 }}>
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    <div className="d-flex align-items-center gap-2" style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>
                      {item.sub_category && <span className="text-truncate">{item.sub_category.name}</span>}
                      <span>•</span>
                      <span className="fw-semibold" style={{ color: 'var(--primary-orange)' }}>
                ...
                <div className="d-flex align-items-center gap-2" style={{ width: '100%', overflow: 'hidden' }}>
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div className="d-flex align-items-center justify-content-between gap-1">
                      <h6
                        className="text-truncate mb-0"
                        style={{ color: 'var(--text-primary)', fontWeight: 700, fontSize: '0.88rem' }}
                      >
                        {item.title}
                      </h6>
                      {getStatusBadge(item.status, item.is_disabled)}
