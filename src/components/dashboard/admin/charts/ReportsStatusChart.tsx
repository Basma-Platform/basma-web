...
/**
 * Reports Status — Donut chart with custom colors from API
 */
const ReportsStatusChart = ({
  data,
  height = 260,
}: ReportsStatusChartProps) => {
  ...
  const option = useMemo(() => {
    ...
    const colors = data.colors || ['#FFC107', '#28A745', '#6B4226'];
      ...
      series: [
        {
          ...
          emphasis: {
            ...
            itemStyle: {
              shadowBlur: 20,
              shadowColor: 'rgba(220,53,69,0.35)',
            },
          },
