...
interface AdminProfileImageUploaderProps {
  currentImage: string | null;
  userName: string;
  onImageUpdate?: (newImagePath: string) => void;
}

const AdminProfileImageUploader = ({
  currentImage,
  userName,
  onImageUpdate,
}: AdminProfileImageUploaderProps) => {
  const { isDark } = useTheme();
  const { uploadAdminImage } = useAdminProfile();
...
export default AdminProfileImageUploader;