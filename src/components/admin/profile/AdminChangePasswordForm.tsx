...
interface PasswordInputProps {
  name: keyof AdminChangePasswordFormData;
  register: UseFormRegister<AdminChangePasswordFormData>;
  show: boolean;
  onToggleShow: () => void;
  placeholder: string;
  error?: string;
...
interface AdminChangePasswordFormProps {
  onSubmit: (data: AdminChangePasswordFormData) => Promise<void>;
  isLoading?: boolean;
}
...
const AdminChangePasswordForm = ({
  ...
  // Submit Handler
  // ============================================
  const handleFormSubmit = async (data: AdminChangePasswordFormData) => {
    try {
      await onSubmit({
                        ...
                        style={{
                          ...
                          cursor:
                            isSubmitting || isLoading || !isDirty
                              ...
                              : 'pointer',
                          opacity:
                            isSubmitting || isLoading || !isDirty ? 0.7 : 1,
                          boxShadow:
